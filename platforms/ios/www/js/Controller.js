    ...
    .controller('ListsConttroller', function ($scope, $stateParams, $ionicModal, $http, $state, $localStorage) {
      ...
      $scope.$storage = $localStorage.$default({
        ...
        $scope.addCategory = function(data){
          ...
          console.log("Avant foreach = ", data);

          angular.forEach($scope.categorie, function(value, key) {

            console.log("pendant foreach data = ",data);
            console.log("pendant foreach key = ",key);
            console.log("pendant foreach value = ",value);

            if (data == value) {
              console.log('On retire la valeur entrée deux fois');
            ...
            console.log("fin foreach, categorie = ",$scope.categorie);
